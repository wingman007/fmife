...
//	mongoose.connect('mongodb://node:node@mongo.onmodulus.net:27017/uwO3mypu'); 	// connect to mongoDB database on modulus.io
	...
	app.configure(function() {
		app.use(express.static(__dirname + '/webProject')); 		// set the static files location /public/img will be /img for users
	...
	app.get('*', function(req, res) {
		res.sendfile('./webProject/index.html'); // load the single view file (angular will handle the page changes on the front-end)
	});
